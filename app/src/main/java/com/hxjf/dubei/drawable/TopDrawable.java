package com.hxjf.dubei.drawable;
...
public class TopDrawable extends Drawable {
    ...
    public void setColor(int color) {
        ...
        paintShadow.setShadowLayer(21, 0, 0, color & 0x26ffffff);//0x2600A4A0
        invalidateSelf();
    }
    ...
    public void onBoundsChange(Rect bounds) {
        ...
        path.addRoundRect(rectF, new float[]{10, 10, 10, 10, 10, 10, 10, 10}, Path.Direction.CW);
    }
