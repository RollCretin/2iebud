...
package com.hxjf.dubei.zxing.camera;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = ScreenSizeUtil.Dp2Px(DuBeiApplication.getContext(),240);
	private static final int MIN_FRAME_HEIGHT = ScreenSizeUtil.Dp2Px(DuBeiApplication.getContext(),180);
	private static final int MAX_FRAME_WIDTH = ScreenSizeUtil.Dp2Px(DuBeiApplication.getContext(),1200); // = 5/8 * 1920
	private static final int MAX_FRAME_HEIGHT = ScreenSizeUtil.Dp2Px(DuBeiApplication.getContext(),675); // = 5/8 * 1080
...
//					MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
			...
			int height = screenResolution.y * 1/ 4;//设定框框高度大小
