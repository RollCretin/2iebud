...
public class Person_BookFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.view_bs_book, null);
    ...
    private void init() {
        ...
        Call<BSBookListBean> personBookListCall = ReaderRetroift.getInstance(getActivity()).getApi().personBookListCall(userId);
