...
/**
 * Created by Chen_Zhang on 2017/12/6.
 */

public class ChallegeDubiCardView extends LinearLayout {
    ...
    public ChallegeDubiCardView(Context context) {
        super(context);
        init(context);
    }

    public ChallegeDubiCardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ChallegeDubiCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }
    public void init(final Context context) {
        RelativeLayout layout = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.view_home_give_dubi, null);
        ...
        cardLayout = (RelativeLayout) layout.findViewById(R.id.change_dubi_card_layout);
