...
class OPDSFeedHandler extends AbstractOPDSFeedHandler implements OPDSConstants {
	 ...
	 *
	 * @param baseURL    string that contains URL of the OPDS feed, that will be selector_book_read_done using this instance of the reader
	 * @param result     network results buffer. Must be created using OPDSNetworkLink corresponding to the OPDS feed,
	 *                   that will be selector_book_read_done using this instance of the reader.
	 */
