...
//        }
    ...
    public  static void checkPermission2(final Fragment fragment, View view, final String[] permissions, final int requestCode, permissionInterface permissionInterface) {
        //小于23 就什么都不做
//        if (Build.VERSION.SDK_INT < 23) {
//            return;
//        }
        ...
        for (String permission :
                permissions) {
            flag = ActivityCompat.checkSelfPermission(fragment.getContext(), permission);
    ...
    public static void requestContactsPermissions(final Activity activity,View view, final String[] permissions, final int requestCode) {
        ...
        if (shouldShowPermissions(activity,permissions)) {
            ...
            Snackbar.make(view, "需要一些权限，否则会导致某些功能不可使用",
