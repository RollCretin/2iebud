...
public class ChallegeTimeCardView extends LinearLayout {
    ...
    public ChallegeTimeCardView(Context context) {
        super(context);
        init(context);
    }

    public ChallegeTimeCardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ChallegeTimeCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }
    public void init(final Context context) {
        LinearLayout layout = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.view_home_read_change_time, null);
        ...
        cardLayout = (LinearLayout) layout.findViewById(R.id.change_time_card_layout);
