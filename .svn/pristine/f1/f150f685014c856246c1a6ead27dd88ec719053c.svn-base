...
public class BookDetailActivity extends BaseActivity {
    ...
    @OnClick({R.id.book_detail_back, R.id.book_detail_share, R.id.book_detail_add_challenge, R.id.book_detail_book_profile_more, R.id.book_detail_author_profile_more, R.id.book_detail_catalog_profile_more, R.id.book_detail_start_read, R.id.challenge_select})
